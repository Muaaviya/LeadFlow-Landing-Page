...
const CTASection = () => {
    return (
        <section className="py-10 xs:py-12 sm:py-20 md:py-24 relative">
            <div className="container mx-auto px-3 xs:px-4 sm:px-6">
                <div className="relative rounded-lg xs:rounded-xl sm:rounded-2xl overflow-hidden p-5 xs:p-6 sm:p-10 md:p-12 lg:p-16 text-center">
                    <ShaderBackground />
