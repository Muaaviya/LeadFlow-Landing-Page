      ...
      <>
        ...
        >
          <div
            ...
            style={{
              gridTemplateColumns: `repeat(${GRID_HOVER_NUM_COLS}, 1fr)`,
              gridTemplateRows: `repeat(${GRID_HOVER_NUM_ROWS}, 1fr)`,
            }}
          >
  ...
  if (variant === "hoverborder") {
    ...
    return (
      <>
        ...
        >
          <div className="hoverborder-variant-ripple-container absolute inset-0 rounded-[inherit] overflow-hidden pointer-events-none">
            <div
              className="absolute inset-0 grid z-2"
              style={{
                gridTemplateColumns: `repeat(${GRID_HOVER_NUM_COLS}, 1fr)`,
            ...
            >
              {Array.from({ length: GRID_HOVER_TOTAL_CELLS }).map((_, i) => (
                <div
                  key={i}
                  className="hoverborder-variant-grid-cell pointer-events-auto"
                />
              ))}
              <div
